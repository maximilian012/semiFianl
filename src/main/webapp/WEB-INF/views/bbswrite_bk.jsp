		...
		<form action="bbswriteAF.do" method="post" enctype="multipart/form-data">
		 <input type="hidden" name="writer" value="<%=login.getUser_id() %>">
				<div class="mb-3">
					...
					<input type="file" class="form-control" name="thumbnail" id="thumbnail" placeholder="썸네일용 사진을 올려주세요(5mb제한)" onchange="fileSize(this)">
	...
	<script type="text/javascript">
				...
				const fileSize = ($target) => {
					  ...
					  if(file.size> 1024*1024*5) {
							alert("섬네일용 이미지는 5MB미만 이미지만 이용가능 합니다.");
